...
local globalKeys =
    ...
    -- Hotkeys
      ...
      awful.key({ 'Control', modkey, }, 'Left', awful.tag.viewprev, { description = 'view previous', group = 'tag' }),
      awful.key({ 'Control', modkey, }, 'Right', awful.tag.viewnext, { description = 'view next', group = 'tag' }),
