...
mylauncher = awful.widget.launcher({
  image = "/usr/share/icons/hicolor/scalable/apps/void-logo-notext.svg",
  menu = mymainmenu
})
...
local function set_wallpaper(s)
  ...
  if beautiful.wallpaper then
    local wallpaper = "/home/hanshi/.config/variety/Favorites/Void-Wallpapers/assets/walls/76.png"
