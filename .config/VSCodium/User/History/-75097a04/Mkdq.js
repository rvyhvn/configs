...
function updateMuzzlePosition() {
  const cannonMuzzleOffsetX = Math.cos(cannonBody.rotation() * cannonBody.width() - 35);
  const cannonMuzzleOffsetY = Math.sin(cannonBody.rotation() * cannonBody.width() - 35);
  cannonMuzzle.x(cannonMuzzleOffsetX);
  cannonMuzzle.y(cannonMuzzleOffsetY);
  cannonMuzzle.rotation(cannonBody.rotation());
}
